...
Use GPT-5.6 Sol with Ultra reasoning for the first 1–3 open-ended brainstorming rounds, then GPT-5.6 Sol with Medium reasoning after the direction is clear to complete stage-one research and `RESEARCH.md`. For stage two and stage three, use GPT-5.6 Terra with Low reasoning and a `/goal` objective tied respectively to `experiments/TODO.md` or `paper/TODO.md`.
